...
extern void string_free(String_t* str); /* deletes the underlying memory the inner string resides in note that the 
                                    str struct wont get freed, only the inner string*/